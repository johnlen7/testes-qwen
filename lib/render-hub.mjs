...
export function renderHub(projects, results) {
...
<header class="head">
  ...
  <p class="head-note">As notas vêm de avaliação por leitura estática de código, sem confirmação visual. São preliminares.</p>
</header>
<main class="grid">
${cards}
</main>
